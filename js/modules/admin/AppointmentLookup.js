                            ...
                            props: {
                                onload: function(){
                                    return new Promise(resolve =>{
                                        ...
                                        data.forEach(group=>{
                                            appointmentsGroup += /*html*/ `<appointment-group date="${group.formatted_date}" items='${JSON.stringify(group.appointments)}' editable="false"></appointment-group>`;
                                        });
                                        this.setData({
                    ...
                    <div class="d-flex flex-1 w-100 p-1 p-md-3 p-xl-4 no-scroll">
                        <div class="w-100 d-flex flex-column h-100 align-items-center justify-content-center p-3">
                            <div class="text-center">
                                ...
                                <pageless-button text="Check Appointment" classname="btn btn-primary" onclick="{{this.props.oncheckclick}}"></pageless-button>
                            </div>
                        </div>
                    </div>
                </div>
