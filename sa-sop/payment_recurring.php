...
<form id="payment_form" action="payment_confirm.php" method="post">
    ...
    <fieldset>
        ...
        <div id="paymentDetailsSection" class="section">
            ...
            <span>merchant_descriptor:</span>         <input type="text" name="merchant_descriptor" value="Hub2">
    </fieldset>
    <p>
    <fieldset>
        ...
        The name of each unsigned field should be included in the unsigned_field_names.
			...
			<span>consumer_id:</span>                 <input type="text" name="consumer_id" value="123456789"><br/>
    ...
    <!-- MDD START -->
    <input type="hidden" name="customer_ip_address" value="<?php echo $ip_address ?>">
