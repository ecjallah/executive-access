...
define('SUB_DELETEDASHBOARD', '10020231007220325');
define('SUB_NAME_DELETEDASHBOARD', 'Deletedashboard');
Auth::module_function_registration(SUB_DELETEDASHBOARD, SUB_NAME_DELETEDASHBOARD, MODULE_DASHBOARD_HANDLER_ID);
...
class Deletedashboard {
    ...
    function __construct(){
        if(isset($_SESSION["user_id"])){
            ...
            $auth              = Auth::function_check('SUB_DELETEDASHBOARD', $this->userId, $this->user_type);
